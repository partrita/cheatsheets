...
*동기*: 학술 논문은 독학으로 그래픽스를 공부하는 프로그래머나 데이터 분석가에게 부담스러울 수 있습니다. :)

이 가이드는 아직 완성되지 않았습니다. 오류를 발견하거나 기여하고 싶다면 #link("https://github.com/Jam3/math-as-code/issues")[이슈를 열거나] PR을 보내주세요.

#quote[
  *참고*: #link("https://www.numpy.org/")[numpy]를 사용한 벡터화에 대한 논의가 일부 포함됩니다.

  *참고*: 이 문서는 `python3`를 기준으로 하며, `python2`와의 중요한 차이점이 있다면 이슈로 제기해 주세요.
]
