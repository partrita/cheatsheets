...
- Node.js: V8 JavaScript 엔진 기반 JavaScript 런타임
- 비동기 I/O: Non-blocking I/O 모델로 고성능 제공
- 이벤트 기반: 이벤트 루프 기반 비동기 처리
- 단일 스레드: 단일 메인 스레드 및 내부 스레드 풀 사용
- NPM: Node Package Manager, 패키지 관리 도구

= 2. 설치 및 버전 관리

- Node.js 설치: https://nodejs.org 다운로드
...
== 패키지 정보
- 설치 패키지 목록: `npm list` (로컬), `npm list -g` (전역)
...
- Chrome DevTools: chrome://inspect 연결
