...
SciPy는 과학적, 공학적 수치 계산을 위해 설계된 파이썬 생태계의 핵심 라이브러리입니다. NumPy를 기반으로 구축되었으며, 최적화, 선형대수, 적분, 보간, 특수 함수, FFT, 신호 및 이미지 처리, 상미분 방정식 풀이 등 다양한 고수준의 알고리즘과 도구를 제공합니다.
