...
Git은 소스 코드의 버전을 로컬에서 추적하고 원격 저장소와 연동하여 협업하는 분산 버전 관리 시스템입니다. 자주 사용하는 핵심 명령어를 빠르게 참고할 수 있도록 정리했습니다.
...
- `git commit -m "msg"`: 스테이징된 변경 사항을 커밋합니다. (`-am`은 추적 중인 파일 스테이징 및 커밋)
