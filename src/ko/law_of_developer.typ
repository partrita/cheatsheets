...
병렬 처리를 통한 속도 향상은 병렬화가 불가능한 순차 작업 비율에 의해 결정된다.
...
== Dunning-Kruger 효과
지식이 얕을수록 자신의 능력을 과대평가하는 경향. 지속적인 학습과 메타인지가 필수적임.
...
인터넷에서 올바른 답을 얻는 가장 빠른 방법은 질문을 올리기보다 잘못된 답을 게시하는 것이다.
...
정체기를 돌파하는 가장 확실한 방법 중 하나는 투입하는 절대적인 '양(Volume)'을 늘리는 것이다.
...
== 집중의 본질은 '중단'
진정한 집중이란 더 많은 일을 하는 것이 아니라, 불필요한 대부분의 일을 멈추는 것이다.
...
== 더 적은 일을 하기
최고의 생산성은 일을 빨리 해치우는 것이 아니라, 불필요한 일을 찾아 제거하는 것이다.
