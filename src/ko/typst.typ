...
#text(font: "Noto Serif CJK KR")[ 
  = 배경
  빙하 역학에서는 유체역학 원리를 바탕으로 얼음의 유동, 온도·압력 분포, 간극수압의 영향을 분석합니다.
]

= 섹션 6: Typst 문법 안내서

Typst는 직관적인 문법과 강력한 프로그래밍 기능을 갖춘 차세대 문서 조판 시스템입니다.
...
Typst는 주요 문서 요소를 위한 내장 마크업을 지원합니다. 대부분의 마크업 구문은 대응하는 내장 함수의 간결한 축약형입니다. 아래 표는 주요 마크업과 대응 함수를 정리한 요약입니다.
...
코드 블록과 표현식 내부에서는 선행 `#` 없이 함수와 변수를 직접 작성합니다.
